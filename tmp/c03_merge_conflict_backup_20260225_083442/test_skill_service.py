...
def test_skill_versioning_model_should_define_version_field() -> None:
    """Skill 版本治理要求 AgentSkill 至少具备版本字段。"""

    from app.models.agent_skill import AgentSkill

    assert hasattr(AgentSkill, "version"), "AgentSkill 缺少 version 字段"


def test_skill_binding_service_should_expose_bind_and_rollback_methods() -> None:
    """SkillService 应暴露绑定与回滚入口。"""

    assert hasattr(SkillService, "bind_user_skill"), "SkillService 缺少 bind_user_skill"
    assert hasattr(SkillService, "rollback_user_skill_binding"), "SkillService 缺少 rollback_user_skill_binding"
