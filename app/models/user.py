...
class User(Base):
    ...
    role: Mapped[Optional[str]] = mapped_column(
        String(50),
        default="user",
        comment="系统角色兼容字段: admin/analyst/user",
    )
    ...
    org_code: Mapped[Optional[str]] = mapped_column(String(100), comment="机构代码")
    org_name: Mapped[Optional[str]] = mapped_column(String(200), comment="机构名称")
    dept_code: Mapped[Optional[str]] = mapped_column(String(100), comment="部门代码")
    dept_name: Mapped[Optional[str]] = mapped_column(String(200), comment="部门名称")
