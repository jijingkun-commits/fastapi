...
CONFIG_SPECS: Dict[str, ConfigSpec] = {
    ...
    "feature.enable_document_memory_recall": ConfigSpec(
        key="feature.enable_document_memory_recall",
        source="db-dynamic",
        value_type="boolean",
        default=False,
        env_key="ENABLE_DOCUMENT_MEMORY_RECALL",
        aliases=("memory.document.recall.enabled",),
    ),
    "feature.enable_document_memory_flush": ConfigSpec(
        key="feature.enable_document_memory_flush",
        source="db-dynamic",
        value_type="boolean",
        default=False,
        env_key="ENABLE_DOCUMENT_MEMORY_FLUSH",
        aliases=("memory.document.flush.enabled",),
    ),
    "feature.enable_document_memory_hybrid_search": ConfigSpec(
        key="feature.enable_document_memory_hybrid_search",
        source="db-dynamic",
        value_type="boolean",
        default=False,
        env_key="ENABLE_DOCUMENT_MEMORY_HYBRID_SEARCH",
        aliases=("memory.document.hybrid.enabled",),
    ),
    "feature.enable_document_memory_embedding_worker": ConfigSpec(
        key="feature.enable_document_memory_embedding_worker",
        source="db-dynamic",
        value_type="boolean",
        default=False,
        env_key="ENABLE_DOCUMENT_MEMORY_EMBEDDING_WORKER",
        aliases=("memory.document.embedding.worker.enabled",),
    ),
    "feature.enable_document_memory_admin_api": ConfigSpec(
        key="feature.enable_document_memory_admin_api",
        source="db-dynamic",
        value_type="boolean",
        default=False,
        env_key="ENABLE_DOCUMENT_MEMORY_ADMIN_API",
        aliases=("memory.document.admin_api.enabled",),
    ),
    "feature.enable_document_memory_admin_web": ConfigSpec(
        key="feature.enable_document_memory_admin_web",
        source="db-dynamic",
        value_type="boolean",
        default=False,
        env_key="ENABLE_DOCUMENT_MEMORY_ADMIN_WEB",
        aliases=("memory.document.admin.web.enabled",),
    ),
    "feature.enable_document_memory_admin_audit": ConfigSpec(
        key="feature.enable_document_memory_admin_audit",
        source="db-dynamic",
        value_type="boolean",
        default=False,
        env_key="ENABLE_DOCUMENT_MEMORY_ADMIN_AUDIT",
        aliases=("memory.document.admin.audit.enabled",),
    ),
