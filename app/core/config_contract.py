...
CONFIG_SPECS: Dict[str, ConfigSpec] = {
    ...
    "feature.enable_progressive_skill_loading": ConfigSpec(
        key="feature.enable_progressive_skill_loading",
        source="db-dynamic",
        value_type="boolean",
        default=True,
        env_key="ENABLE_PROGRESSIVE_SKILL_LOADING",
    ),
    "skill.runtime_mode": ConfigSpec(
        key="skill.runtime_mode",
        source="db-dynamic",
        value_type="string",
        default="catalog_tool",
        env_key="SKILL_RUNTIME_MODE",
    ),
    "feature.enable_skill_runtime_trace": ConfigSpec(
        key="feature.enable_skill_runtime_trace",
        source="db-dynamic",
        value_type="boolean",
        default=True,
        env_key="ENABLE_SKILL_RUNTIME_TRACE",
    ),
    "feature.enable_skill_catalog_metadata_normalization": ConfigSpec(
        key="feature.enable_skill_catalog_metadata_normalization",
        source="db-dynamic",
        value_type="boolean",
        default=True,
        env_key="ENABLE_SKILL_CATALOG_METADATA_NORMALIZATION",
    ),
