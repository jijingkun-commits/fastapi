...
# DIDP 工作空间路径
DIDP_WORKSPACE = PROJECT_ROOT / "data/DIDP_PROJECT_WORKSPACE"
...
def main():
    ...
    if not DIDP_WORKSPACE.exists():
        print(f"错误：DIDP 工作空间不存在 - {DIDP_WORKSPACE}")
        print("请确保 data/DIDP_PROJECT_WORKSPACE 目录存在")
        sys.exit(1)
