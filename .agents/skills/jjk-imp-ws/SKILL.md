---
name: jjk-imp-ws
description: "Use when you need `jjk-imp-ws` in this repository. Source intent: WS 执行入口（消费 /jjk-vkplan 契约）：按单个工作包实现、验证与回填，支持大 WS 自动 Team"
---
