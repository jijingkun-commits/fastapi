---
name: jjk-design
description: "Use when you need `jjk-design` in this repository. Source intent: 技术方案入口：基于 requirements 和现有代码写出能落地的 design 文档，包含最佳实践判断、技术图、模块改造清单、删除清单和实现种子"
---
<!-- AUTO-GENERATED: jjk-skill-mirror -->
<!-- source: .cursor/commands/jjk-design.md -->
