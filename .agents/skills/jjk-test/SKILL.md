---
name: jjk-test
description: "Use when you need `jjk-test` in this repository. Source intent: 测试入口（消费 review/plan/manifest）：执行可追溯测试矩阵并产出测试报告，支持大范围自动 Team"
---
