---
name: jjk-api-docs
description: "Use when you need `jjk-api-docs` in this repository. Source intent: API 文档入口（消费 review/manifest）：契约抽取、示例校验与文档落盘，支持大范围自动 Team"
---
...
2. Codex：`$jjk-api-docs`

> 说明：Codex 推荐显式调用 `$jjk-api-docs`。
