---
name: jjk-deslop
description: "Use when you need `jjk-deslop` in this repository. Source intent: 去冗余入口（消费 review/manifest）：清理 AI 风格冗余实现并产出可追溯报告，支持大范围自动 Team"
---
