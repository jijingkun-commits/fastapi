---
name: jjk-cardrun
description: "Use when you need `jjk-cardrun` in this repository. Source intent: 串行卡片执行入口（消费 /jjk-vkplan 产物）：主控调度 + 子代理逐卡执行 + done_gate 验证 + 会话隔离"
---
