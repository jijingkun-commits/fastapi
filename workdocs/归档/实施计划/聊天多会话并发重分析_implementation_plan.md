...
- design_source: `workdocs/归档/设计/2026-03-04-chat-multi-session-concurrency-reanalysis-design.md`
...
1. 设计文档（已审批）
   `workdocs/归档/设计/2026-03-04-chat-multi-session-concurrency-reanalysis-design.md`
2. 历史并发设计参考
   `workdocs/归档/设计/2026-03-01-chat-multi-session-concurrency-design.md`
3. 停止稳定性参考（防回归）
   `workdocs/归档/实施计划/聊天停止后并发占用稳定性修复_implementation_plan.md`
4. 代码锚点
...
planning_contract:
  ...
  cards:
    - card_id: C01
      ...
      acceptance_checks:
        - cd /Users/jijingkun/bojxAI/fastapi/web && pnpm exec vitest run src/hooks/__tests__/useSSEStream.multi-session.test.ts
      evidence_entry: workdocs/归档/实施计划/聊天多会话并发重分析_implementation_plan.md
...
2. 设计真理源为 `workdocs/归档/设计/2026-03-04-chat-multi-session-concurrency-reanalysis-design.md`。
