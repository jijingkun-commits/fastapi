...
> - Design 输入：`/Users/jijingkun/bojxAI/fastapi/workdocs/归档/设计/2026-03-01-chat-session-continuation-design.md`
...
1. 设计主文档：`workdocs/归档/设计/2026-03-01-chat-session-continuation-design.md`
2. 现有聊天链路代码锚点：
...
planning_contract:
  ...
  cards:
    - card_id: C01
      ...
      acceptance_checks:
        - cd web && pnpm exec eslint src/types/message.ts src/lib/backend.ts
      evidence_entry: workdocs/归档/实施计划/聊天断页续跑与强停止_implementation_plan.md
