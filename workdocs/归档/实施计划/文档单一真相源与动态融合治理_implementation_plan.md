...
> 对应需求：`workdocs/归档/需求/文档单一真相源与动态融合治理_requirements.md`
...
implementation_tasks:
  ...
  - task_id: T06
    ...
    file_paths:
      - workdocs/归档/需求/文档单一真相源与动态融合治理_requirements.md
      - workdocs/归档/实施计划/文档单一真相源与动态融合治理_implementation_plan.md
    symbols:
    ...
    acceptance_cmds:
      ...
      - 先执行 `bash scripts/repo_python.sh` 获取解释器，再执行 `<PYTHON_BIN> scripts/check_workflow_contract.py --mode planning_temporal_gate --implementation-path workdocs/归档/实施计划/文档单一真相源与动态融合治理_implementation_plan.md --output workdocs/归档/机读校验/文档单一真相源与动态融合治理_planning_temporal_gate.json`
```
