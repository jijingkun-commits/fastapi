...
1. `workdocs/归档/设计/2026-03-03-parallel-task-worktree-namespace-design.md`
2. `workdocs/归档/需求/多任务并行Worktree命名空间与异步收口_requirements.md`
...
- 设计文档：`workdocs/归档/设计/2026-03-03-parallel-task-worktree-namespace-design.md`
  ...
  cards:
    - card_id: C01
      ...
      acceptance_checks:
        - bash scripts/coder4/wt-flow.sh next --state-dir docs/内部参考/任务拆解/<task_split_dir>/.state/<task_key>
        - bash scripts/coder4/wt-flow.sh list --state-dir docs/内部参考/任务拆解/<task_split_dir>/.state/<task_key>
      evidence_entry: workdocs/归档/实施计划/多任务并行Worktree命名空间与异步收口_implementation_plan.md
