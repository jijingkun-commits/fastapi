...
> 上游设计：`workdocs/归档/设计/2026-03-05-preference-intent-judge-design.md`
> 关联需求：`workdocs/归档/需求/preference-intent-judge_requirements.md`
...
implementation_tasks:
  ...
  - task_id: T-03
    ...
    acceptance_cmds:
      ...
      - python3 scripts/check_workflow_contract.py --mode clarify_plan --requirements-path workdocs/归档/需求/preference-intent-judge_requirements.md --implementation-path workdocs/归档/实施计划/preference-intent-judge_implementation_plan.md --output workdocs/归档/机读校验/preference-intent-judge_clarify_plan_alignment.json
      - python3 scripts/check_workflow_contract.py --mode planning_temporal_gate --implementation-path workdocs/归档/实施计划/preference-intent-judge_implementation_plan.md --output workdocs/归档/机读校验/preference-intent-judge_planning_temporal_gate.json
```
...
execution_contract:
  ...
  requirements_source: workdocs/归档/需求/preference-intent-judge_requirements.md
```
