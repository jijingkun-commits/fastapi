...
> 日期：2026-02-27
> 需求基线：`workdocs/归档/需求/多智能体完整交付架构重构_requirements.md`
...
3. `workdocs/归档/实施计划/openclaw迁移重建基线_implementation_plan.md`
4. `workdocs/归档/实施计划/迁移执行波次_implementation_plan.md`
5. `workdocs/归档/实施计划/streaming_wrapper简化_implementation_plan.md`
...
planning_contract:
  ...
  cards:
    - card_id: C00
      ...
      evidence_entry: workdocs/归档/实施计划/多智能体完整交付架构重构_implementation_plan.md
    - card_id: C01
      wave: P1
      feature_ids: [P1-01]
      depends_on: [C00]
