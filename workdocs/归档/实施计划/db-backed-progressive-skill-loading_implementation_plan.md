...
> 上游设计：`workdocs/归档/设计/2026-03-07-db-backed-progressive-skill-loading-design.md`
> 对应需求：`workdocs/归档/需求/db-backed-progressive-skill-loading_requirements.md`
...
planning_contract:
  task_to_pr_mapping:
    ...
    - task_id: T-06
      ...
      acceptance_cmds:
        - PYTHONPATH=. pytest app/tests/test_skill_catalog_manifest.py app/tests/test_skill_loader_tool.py app/tests/test_skill_runtime_replay.py app/tests/test_skill_runtime_mode_switch.py app/tests/test_skill_admin_catalog_metadata.py -q
        - python3 scripts/check_workflow_contract.py --mode clarify_plan --requirements-path workdocs/归档/需求/db-backed-progressive-skill-loading_requirements.md --implementation-path workdocs/归档/实施计划/db-backed-progressive-skill-loading_implementation_plan.md --output -
      rollback_point: 回退本次新增测试与文档并恢复 design 基线
  execution_mode: core
