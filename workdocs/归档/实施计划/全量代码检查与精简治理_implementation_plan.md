...
> 对应需求：`/Users/jijingkun/bojxAI/fastapi/workdocs/归档/需求/全量代码检查与精简治理_requirements.md`
...
- 设计文档：`/Users/jijingkun/bojxAI/fastapi/workdocs/归档/设计/2026-03-02-full-code-audit-slimming-design.md`
...
1. `workdocs/归档/设计/2026-03-02-full-code-audit-slimming-design.md`
...
|---|---|---|---|---|---|---|---|---|
| P1-01 | C01 | 全量热点审计台账；不改业务逻辑 | 扫描执行 -> 输出热点分级 -> 固化台账 | `scripts/ci/check_change_budget.py`（新增）；`workdocs/归档/设计/2026-03-02-full-code-audit-slimming-design.md` | `module/type/risk/evidence` | 回退到只读报告模式 | `python3 scripts/ci/check_change_budget.py --mode always --strict --diff-range origin/master...HEAD` | design §1.2 |
...
implementation_tasks:
  - task_id: T-01
    ...
    file_paths:
      ...
      - workdocs/归档/实施计划/全量代码检查与精简治理_implementation_plan.md
    symbols:
  ...
  - task_id: T-09
    ...
    file_paths:
      - docs/SUMMARY.md
      - workdocs/归档/需求/全量代码检查与精简治理_requirements.md
      - workdocs/归档/实施计划/全量代码检查与精简治理_implementation_plan.md
    symbols:
      - planning_contract
  ...
  cards:
    - card_id: C01
      ...
      acceptance_checks:
        - python3 scripts/ci/check_change_budget.py --mode always --strict --diff-range origin/master...HEAD
        - python3 scripts/check_special_doc_sync.py --strict
      evidence_entry: workdocs/归档/实施计划/全量代码检查与精简治理_implementation_plan.md
