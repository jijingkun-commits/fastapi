...
> 更新时间：2026-03-08
> 上游输入：`workdocs/归档/设计/2026-03-06-intent-optimization-runtime-contract-v2-design.md`、`workdocs/归档/需求/意图优化_requirements.md`
...
execution_contract:
  ...
  requirements_source: workdocs/归档/需求/意图优化_requirements.md
```
