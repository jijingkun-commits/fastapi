...
1. `workdocs/归档/需求/文档记忆混合检索_requirements.md`
2. `workdocs/归档/需求/文档化永久记忆_requirements.md`
3. `workdocs/归档/实施计划/文档化永久记忆_implementation_plan.md`
4. `workdocs/归档/研究报告/用户资产_superpowers_omx融合参考报告_20260228.md`
5. OpenClaw 参考：
  ...
  cards:
    - card_id: C01
      ...
      acceptance_checks:
        - venv/bin/python -m pytest -q tests/unit/test_document_memory_repo_hybrid_search.py
        - venv/bin/python -m pytest -q tests/unit/test_document_memory_service_hybrid.py
      evidence_entry: workdocs/归档/实施计划/文档记忆混合检索_implementation_plan.md
