...
引用来源：`docs/开发文档/流程与工具/Coder4自动执行总控手册.md` 第 2.2 节
...
| `docs/开发文档/流程与工具/Coder4自动执行总控手册.md` | 中改 | ~50 行 | 从 VK 看板改为本地状态 |
| `docs/开发文档/流程与工具/开发工作流.md` | 小改 | ~10 行 | 更新工作流描述 |
| `docs/开发文档/流程与工具/VibeKanban多Worktree本机开发测试.md` | 归档 | 全文 | 标记为历史文档 |
| `docs/开发文档/流程与工具/OpenClaw自动执行故障字典.md` | 中改 | ~30 行 | 移除 VK 相关故障条目 |
| `docs/开发文档/流程与工具/AI协作速查表.md` | 小改 | ~5 行 | 移除 VK 引用 |
| `docs/开发文档/流程与工具/vibe-coding开发技巧.md` | 小改 | ~5 行 | 移除 VK 引用 |
| `workdocs/README.md` | 小改 | ~5 行 | 更新拆解流程说明 |
| `workdocs/任务拆解/_templates/parallel_plan_template.md` | 小改 | ~10 行 | 移除 VK 引用 |
| `.cursor/rules/mcp-routing.mdc` | 小改 | ~5 行 | 移除 VK MCP 路由规则 |
| `workdocs/归档/正文/实施计划/openclaw迁移重建基线_implementation_plan.md` | 小改 | ~10 行 | 移除 VK 引用 |
...
| `.artifacts/states/task_splits/<task_split_dir>/<task_key>/task-runner-state.json` | 运行时状态文件（自动生成） | - |
| `scripts/vk_sync_push.py`（仅 Phase 1） | 异步推送本地状态到 VK（过渡期） | 80-120 行 |
| `.cursor/commands/jjk-task.md` | 替代 `/jjk-vktodo` 的本地任务管理命令 | 100-150 行 |
| `docs/开发文档/流程与工具/本地任务编排手册.md` | 替代 VK 相关文档 | 100-150 行 |
...
| `docs/开发文档/流程与工具/VibeKanban多Worktree本机开发测试.md` | ~100 | VK 专属测试文档 |
...
|---------|---------|
| `.mcp.json` | 3.1, 3.4 |
| `workdocs/归档/任务拆解/2026-02-21_openclaw迁移重建基线/contracts/vk_cards.json` | 2.3, 3.1 |
| `workdocs/任务拆解/<task_split_dir>/contracts/_active_task.json` | 2.3, 3.1 |

### 文档文件

| 文件路径 | 引用章节 |
|---------|---------|
| `docs/开发文档/流程与工具/Coder4自动执行总控手册.md` | 2.3, 3.4 |
| `docs/开发文档/流程与工具/开发工作流.md` | 3.4 |
| `docs/开发文档/流程与工具/VibeKanban多Worktree本机开发测试.md` | 3.4 |
| `docs/开发文档/流程与工具/OpenClaw自动执行故障字典.md` | 3.4 |
| `docs/开发文档/流程与工具/AI协作速查表.md` | 3.4 |
| `docs/开发文档/流程与工具/vibe-coding开发技巧.md` | 3.4 |
| `workdocs/README.md` | 3.4 |
| `workdocs/任务拆解/_templates/parallel_plan_template.md` | 3.4 |
| `workdocs/归档/正文/实施计划/openclaw迁移重建基线_implementation_plan.md` | 3.4 |
...
## 当前任务链
- active_task: workdocs/任务拆解/<task_split_dir>/contracts/_active_task.json
- task_runner_state: .artifacts/states/task_splits/<task_split_dir>/<task_key>/task-runner-state.json
- ledger: .artifacts/states/task_splits/<task_split_dir>/<task_key>/task-ledger.jsonl
...
# task_runner_state_path = .artifacts/states/task_splits/<task_split_dir>/<task_key>/task-runner-state.json
```
...
| `docs/开发文档/流程与工具/本地任务编排手册.md` | 替代 VK 相关文档 | 100-150 |
