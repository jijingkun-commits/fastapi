...
**Files:**
- Create: `workdocs/归档/设计/2026-03-06-mcp-governance-design.md`
- Create: `workdocs/归档/设计/2026-03-06-mcp-governance-plan.md`
...
**Step 3: 自检文档完整性**
Run: `rg -n '权威配置|Token|vibe_kanban|体检' workdocs/归档/设计/2026-03-06-mcp-governance-*.md`
Expected: 命中设计与计划关键字。
