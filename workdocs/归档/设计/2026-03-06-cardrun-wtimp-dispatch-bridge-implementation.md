...
- 任务真理源：`docs/内部参考/任务拆解/<task_split_dir>/_active_task.json`
- 运行态真理源：`docs/内部参考/任务拆解/<task_split_dir>/.state/<task_key>/task-runner-state.json`
- 会话真理源：`docs/内部参考/任务拆解/<task_split_dir>/.state/<task_key>/active-session-<session_id>.json`
- 证据真理源：`docs/内部参考/任务拆解/<task_split_dir>/.state/<task_key>/task-ledger.jsonl`
...
Plan complete and saved to `workdocs/归档/设计/2026-03-06-cardrun-wtimp-dispatch-bridge-implementation.md`. Two execution options:
