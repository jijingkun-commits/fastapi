...
**Files:**
- Create: `workdocs/归档/设计/2026-03-08-memory-intent-resolver-contract-design.md`
- Create: `workdocs/归档/设计/2026-03-08-memory-intent-resolver-contract-plan.md`
...
**Step 4: 自检文档同步**
Run: `rg -n 'resolver|contract|异步|chat_service|normalized_value' workdocs/归档/设计/2026-03-08-memory-intent-resolver-contract-*.md memory-bank.md`
