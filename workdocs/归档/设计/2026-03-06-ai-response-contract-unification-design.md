...
clarify_handoff_contract:
  ...
  design_source: "workdocs/归档/设计/2026-03-06-ai-response-contract-unification-design.md"
  handoff_ready: true
  required:
    requirement_seeds:
      - design_item: D-01
...
- approval_evidence: "用户回复“好的”，确认将采纳评估回填；本轮结论为“修订后采纳（Adopt with Changes）”，P0（异常语义唯一化、契约源机制唯一化、handoff required 补齐 D-03）完成前维持 NO_GO，不进入 /jjk-plan。评估依据：workdocs/归档/设计/2026-03-06-ai-response-contract-unification-adoption-review.md"
