...
```yaml
automation_contract:
  source_of_truth: workdocs/归档/任务拆解/2026-02-21_openclaw迁移重建基线/contracts/_active_task.json
  required_fields:
    - project_id
    - task_split_dir
    - task_key
...
3. cron 消费口径复核：
   - `docs/开发文档/流程与工具/Coder4自动执行总控手册.md` 要求按 `card_order` 单卡滚动创建。
...
- 协议机读文件: `workdocs/归档/任务拆解/2026-02-21_openclaw迁移重建基线/contracts/sse_events_v1.json`
