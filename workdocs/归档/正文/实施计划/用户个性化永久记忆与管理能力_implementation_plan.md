...
1. `workdocs/归档/正文/设计/2026-03-03-user-personalized-memory-llm-async-design.md`
2. `workdocs/归档/正文/需求/用户个性化永久记忆与管理能力_requirements.md`
3. OpenClaw 参考：
...
- 设计文档：`workdocs/归档/正文/设计/2026-03-03-user-personalized-memory-llm-async-design.md`
