...
> 上游输入：`workdocs/归档/正文/设计/2026-03-06-cardrun-wtimp-executor-design.md`、`workdocs/归档/正文/需求/cardrun内置wtimp执行器_requirements.md`
> 当前模式：`core`（进入执行链）

## 0. 输入来源清单

- design: `workdocs/归档/正文/设计/2026-03-06-cardrun-wtimp-executor-design.md`
- requirements: `workdocs/归档/正文/需求/cardrun内置wtimp执行器_requirements.md`
- 关键代码入口:
...
implementation_tasks:
  ...
  - task_id: T-04
    ...
    file_paths:
      - scripts/coder4/coder4_bootstrap_kernel.py
      - workdocs/归档/正文/设计/2026-03-06-cardrun-wtimp-executor-design.md
      - docs/内部参考/任务拆解
    symbols:
      - dispatch_executor
  ...
  - task_id: T-05
    ...
    file_paths:
      - scripts/coder4/coder4_bootstrap_kernel.py
      - workdocs/归档/正文/设计/cardrun内置wtimp执行器方案与最小改造清单_20260306.md
    symbols:
      - execution_evidence
      - commit_sha
      - merge_sha
  ...
  - task_id: T-06
    ...
    symbols:
      ...
      - 推荐链路
    acceptance_cmds:
      - python3 scripts/check_clarify_plan_alignment.py --requirements-path workdocs/归档/正文/需求/cardrun内置wtimp执行器_requirements.md --implementation-path workdocs/归档/正文/实施计划/cardrun内置wtimp执行器_implementation_plan.md --output -
...
tc_task_mapping:
  ...
  - tc_id: TC-CW-06
    task_id: T-06
    pr_id: PR-03
    acceptance_cmd_ref: python3 scripts/check_clarify_plan_alignment.py --requirements-path workdocs/归档/正文/需求/cardrun内置wtimp执行器_requirements.md --implementation-path workdocs/归档/正文/实施计划/cardrun内置wtimp执行器_implementation_plan.md --output -
```
