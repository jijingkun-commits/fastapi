...
omx team 3:executor "执行P0屎山治理：按 workdocs/归档/正文/实施计划/P0屎山治理_SSE分发_recovery_policy_SkillService一期_PR拆单_20260228.md 的 PR-01~PR-03 顺序推进；每个PR按 task_id 粒度回填 文件列表、验收命令与回滚点。"
```
