...
> 对应需求：`/Users/jijingkun/bojxAI/fastapi/workdocs/归档/正文/需求/用户Skill严格用户源治理_requirements.md`
...
- 设计文档：`/Users/jijingkun/bojxAI/fastapi/workdocs/归档/正文/设计/2026-03-01-user-skill-strict-runtime-design.md`
...
1. `workdocs/归档/正文/设计/2026-03-01-user-skill-strict-runtime-design.md`
  ...
  cards:
    - card_id: C01
      ...
      acceptance_checks:
        - venv/bin/python -m pytest tests/unit/test_skill_service.py -k version -q
        - venv/bin/python -m pytest tests/unit/test_user_service_skill_bootstrap.py -q
      evidence_entry: workdocs/归档/正文/实施计划/用户Skill严格用户源治理_implementation_plan.md
...
execution_log:
  ...
  - task_id: T-06
    ...
    file_paths:
      ...
      - workdocs/归档/正文/实施计划/用户Skill严格用户源治理_implementation_plan.md
      - docs/SUMMARY.md
    symbols:
      - _build_retrieval_log
