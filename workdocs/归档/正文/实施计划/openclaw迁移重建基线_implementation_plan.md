...
2. `workdocs/归档/正文/实施计划/openclaw全量迁移_implementation_plan.md`
3. `workdocs/归档/正文/实施计划/迁移执行波次_implementation_plan.md`
...
3. 代码/文档锚点：
   - `workdocs/归档/正文/实施计划/openclaw全量迁移_implementation_plan.md`（2.2）
   - `workdocs/归档/正文/实施计划/迁移执行波次_implementation_plan.md`（2.2~2.4）
...
3. 代码/文档锚点：
   - `workdocs/归档/正文/实施计划/迁移执行波次_implementation_plan.md`（11.2~11.5）
...
planning_contract:
  ...
  status_source_of_truth: workdocs/归档/正文/实施计划/迁移执行波次_implementation_plan.md
  gate_contract:
    mode: as_cards
...
2. `single_active_card` 串行约束复核：
   ...
   - `workdocs/任务拆解/<task_split_dir>/contracts/_active_task.json` 顶层 `single_active_card=true`。
