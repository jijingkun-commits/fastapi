...
> 日期：2026-03-03
> 需求基线：`workdocs/归档/正文/需求/监督者移除Planner重构_requirements.md`
> 设计输入：`workdocs/归档/正文/设计/2026-03-02-supervisor-refactor-remove-planner-design.md`
> 模式：`core (plan-only)`

## 0. 输入来源清单

1. `workdocs/归档/正文/设计/2026-03-02-supervisor-refactor-remove-planner-design.md`
2. `workdocs/归档/正文/设计/2026-03-02-supervisor-refactor-remove-planner.md`
3. `workdocs/归档/正文/需求/监督者移除Planner重构_requirements.md`
...
implementation_tasks:
  ...
  - task_id: T-11
    ...
    file_paths:
      - docs/SUMMARY.md
      - workdocs/归档/正文/需求/监督者移除Planner重构_requirements.md
      - workdocs/归档/正文/实施计划/监督者移除Planner重构_implementation_plan.md
    symbols:
      - 迭代需求索引
      - planning_contract
    change_type: modify
...
planning_contract:
  ...
  cards:
    - card_id: C01
      ...
      evidence_entry: workdocs/归档/正文/实施计划/监督者移除Planner重构_implementation_plan.md
