...
- Reference: `workdocs/归档/正文/设计/2026-03-08-engineering-flow-db-evidence-gate-design.md`
...
**Files:**
- Modify: `.cursor/commands/jjk-verify.md`
- Modify: verify templates under `workdocs/_templates/` if needed
...
Run:
```bash
rg -n "PASS|WARN|FAIL|mandatory_evidence|UNPROVEN|验证报告" .cursor/commands/jjk-verify.md workdocs/_templates
```
...
Run:
```bash
rg -n "VERIFY_CHAT_DB_UNPROVEN|VERIFY_DATA_DB_UNPROVEN|mandatory_evidence" .cursor/commands/jjk-verify.md workdocs/_templates
```
Expected: PASS/WARN/FAIL gate wording is aligned.

**Step 5: Commit**
```bash
git add .cursor/commands/jjk-verify.md workdocs/_templates
...
Plan complete and saved to `workdocs/归档/正文/设计/2026-03-08-engineering-flow-db-evidence-gate-implementation.md`. Two execution options:
