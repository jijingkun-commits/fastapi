...
- 模块边界与职责：
  ...
  - `workdocs/任务拆解/2026-03-06_工程减法治理/reports/workflow-gate-usage-report.json`：从运行态日志聚合导出的提交证据，作为退役 GO/NO-GO 判定材料。
  - `.artifacts/states/task_splits/*/*`：运行态证据域，仅按生命周期 + TTL 定向归档。
- 端到端数据流：
...
- implementation_seeds：
  - `P0-FREEZE-COMMANDS`
    - blocked_by: `[]`
    - file_paths: `workdocs/归档/专题/治理专题/工程减法治理/工程减法体检报告_2026-03-06.md`, `workdocs/归档/专题/治理专题/工程减法治理/工程减法体检报告_2026-03-06_v3.md`, `workdocs/归档/专题/治理专题/工程减法治理/工程减法治理看板模板_2026-03-06.md`
  ...
  - `P2-OBSERVABILITY`
    ...
    - file_paths: `scripts/check_workflow_contract.py`, `workdocs/任务拆解/2026-03-06_工程减法治理/reports/workflow-gate-usage-report.json`
    - symbols: `emit_usage_log`, `usage_record_schema_v1`
    - change_type: `add`
  - `P2-TTL-ARCHIVE`
    - blocked_by: `["P2-OBSERVABILITY"]`
    - file_paths: `scripts/*`, `workdocs/任务拆解/*`, `.artifacts/states/task_splits/*`
...
clarify_handoff_contract:
  ...
  extended:
    observability_hints:
      - "运行态统一写入 logs/workflow-gate-usage.jsonl，验收统一导出 workdocs/任务拆解/2026-03-06_工程减法治理/reports/workflow-gate-usage-report.json"
