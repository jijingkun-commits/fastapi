...
**Files:**
- Modify: `workdocs/归档/正文/设计/2026-03-09-lifespan-runtime-consolidation-design.md`
...
Run:
```bash
rg -n "app\.state\.runtime|lifespan 只负责编排|唯一 owner" workdocs/归档/正文/设计/2026-03-09-lifespan-runtime-consolidation-design.md memory-bank.md
```
