...
- 用一次性迁移替代长期双写兼容，删掉旧 task_split 入口下的机器 JSON / 过程 JSON。
- 把文档同步和流程图更新升级成实现硬门禁。

### 1.2 范围
- `workdocs/归档/正文/设计/2026-03-11-docs-governance-phase2-task-split-layering-design.md`
- `workdocs/任务拆解/**`
...
- 不在本轮把历史设计归档再做二次主题重构；先统一收口到 `workdocs/归档/正文/设计/**`。
...
requirements_contract:
  ...
  clarify_handoff_source: workdocs/归档/正文/设计/2026-03-11-docs-governance-phase2-task-split-layering-design.md#clarify_handoff_contract
