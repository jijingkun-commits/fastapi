...
> 上游设计：`workdocs/归档/正文/设计/2026-03-06-workflow-gate-retirement-design.md`
...
- 流程治理文档：`workdocs/归档/专题/治理专题/工程减法治理/工程减法体检报告_2026-03-06.md`、`workdocs/归档/专题/治理专题/工程减法治理/工程减法体检报告_2026-03-06_v3.md`
...
- 观测与归档：`logs/workflow-gate-usage.jsonl`（运行态观测）、`workdocs/任务拆解/2026-03-06_工程减法治理/reports/workflow-gate-usage-report.json`（提交证据）、`.artifacts/states/task_splits/*`（运行态归档域）
...
requirements_contract:
  ...
  status: "approved"
  design_source: workdocs/归档/正文/设计/2026-03-06-workflow-gate-retirement-design.md
  clarify_handoff_source: workdocs/归档/正文/设计/2026-03-06-workflow-gate-retirement-design.md#clarify_handoff_contract
...
fr_contract_matrix:
  - fr_id: FR-01
    ...
    input_contract:
      ...
      source_of_truth: workdocs/归档/专题/治理专题/工程减法治理/工程减法体检报告_2026-03-06.md
    output_contract:
  ...
  - fr_id: FR-05
    ...
    output_contract:
      ...
      evidence_artifact: workdocs/任务拆解/2026-03-06_工程减法治理/reports/workflow-gate-usage-report.json
      consumer: 退役审批人
