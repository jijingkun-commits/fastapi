...
> 上游设计：`workdocs/归档/正文/设计/2026-03-06-cardrun-wtimp-executor-design.md`
...
requirements_contract:
  ...
  status: "approved"
  design_source: workdocs/归档/正文/设计/2026-03-06-cardrun-wtimp-executor-design.md
  clarify_handoff_source: workdocs/归档/正文/设计/2026-03-06-cardrun-wtimp-executor-design.md#clarify_handoff_contract
...
fr_contract_matrix:
  ...
  - fr_id: FR-04
    ...
    input_contract:
      ...
      source_of_truth: workdocs/任务拆解/*/contracts/_active_task.json
    output_contract:
...
traceability_matrix:
  - design_item: D-01 dispatch 执行器路由
    ...
    evidence_entry: workdocs/归档/正文/实施计划/cardrun内置wtimp执行器_implementation_plan.md
