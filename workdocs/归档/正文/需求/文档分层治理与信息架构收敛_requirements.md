...
- 过程文档统一收口到 `workdocs/**`，旧入口不再承载过程正文与机器过程产物。
...
requirements_contract:
  ...
  clarify_handoff_source: workdocs/归档/正文/设计/2026-03-10-docs-governance-layering-design.md#clarify_handoff_contract
...
fr_contract_matrix:
  - fr_id: FR-01
    ...
    input_contract:
      ...
      source_of_truth: workdocs/归档/正文/设计/2026-03-10-docs-governance-layering-design.md
    output_contract:
  ...
  - fr_id: FR-02
    ...
    failure_semantics: 真实运行态文件写入 docs/** 时直接阻断；`task_split` 契约与过程报告必须写入 `workdocs/任务拆解/**`
