...
- 过程文档层：`workdocs/设计/*.md`、`workdocs/归档/正文/设计/*.md`、`workdocs/归档/正文/需求/*.md`、`workdocs/归档/正文/实施计划/*.md`
...
- 不在本轮一次性清洗所有历史主文档。
- 新的设计过程统一进入 `workdocs/设计/`，历史正文统一进入 `workdocs/归档/正文/`。
...
requirements_contract:
  ...
  clarify_handoff_source: workdocs/归档/正文/设计/2026-03-08-doc-single-source-dynamic-governance-design.md#clarify_handoff_contract
...
fr_contract_matrix:
  ...
  - fr_id: FR-02
    ...
    input_contract:
      ...
      source_of_truth: workdocs/设计/*.md + workdocs/归档/正文/设计/*.md + workdocs/归档/正文/需求/*.md + workdocs/归档/正文/实施计划/*.md
    output_contract:
...
traceability_matrix:
  - design_item: D-01-main-doc-current-state-only
    ...
    evidence_entry: workdocs/归档/正文/实施计划/文档单一真相源与动态融合治理_implementation_plan.md
