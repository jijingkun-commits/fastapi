...
> 更新时间：2026-03-08
> 上游设计：`workdocs/归档/正文/设计/2026-03-06-intent-optimization-runtime-contract-v2-design.md`
...
requirements_contract:
  topic: "意图优化"
  status: "approved"
  design_source: workdocs/归档/正文/设计/2026-03-06-intent-optimization-runtime-contract-v2-design.md
  clarify_handoff_source: workdocs/归档/正文/设计/2026-03-06-intent-optimization-runtime-contract-v2-design.md#clarify_handoff_contract
...
fr_contract_matrix:
  ...
  - fr_id: FR-06
    ...
    input_contract:
      ...
      source_of_truth: workdocs/归档/正文/实施计划/意图优化_implementation_plan.md
    output_contract:
...
traceability_matrix:
  - design_item: D-01 runtime_goal_single_source
    ...
    evidence_entry: workdocs/归档/正文/实施计划/意图优化_implementation_plan.md
