...
3. 固化诊断产物契约：
   - 统一输出 `workdocs/归档/修复计划/fix_plan_<topic>.md`；
...
| `jjk-pc` | `systematic-debugging`（诊断方法层） | 大任务自动 Team | `SYSTEMATIC_DEBUGGING_UNAVAILABLE_FALLBACK`、`TEAM_UNAVAILABLE_FALLBACK` | `workdocs/归档/修复计划/fix_plan_<topic>.md` | 已落地 |
...
5. 交付产物统一：
   - `workdocs/归档/调试报告/debug_report_<topic>.md`。
6. 模板体系补齐：
