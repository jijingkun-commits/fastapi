...
> 上游设计：`workdocs/归档/设计/2026-03-09-supervisor-conversation-state-ownership-design.md`
...
requirements_contract:
  ...
  status: approved
  design_source: workdocs/归档/设计/2026-03-09-supervisor-conversation-state-ownership-design.md
  clarify_handoff_source: workdocs/归档/设计/2026-03-09-supervisor-conversation-state-ownership-design.md#clarify_handoff_contract
...
traceability_matrix:
  - design_item: D-01
    ...
    evidence_entry: workdocs/归档/实施计划/监督者主会话状态归属与附件规划_implementation_plan.md
  - design_item: D-02
    fr_id: FR-02
