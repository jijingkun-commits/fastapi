...
- 契约与文档：`contracts/streaming/result-event.schema.json`、`docs/开发文档/代码解读/SSE事件协议.md`、`docs/产品文档/聊天系统需求.md`、`contracts/api/streaming-events.asyncapi.yaml`、`contracts/api/openapi.yaml`
...
requirements_contract:
  ...
  status: "approved"
  design_source: workdocs/归档/设计/2026-03-06-composite-query-multimodal-response-design.md
  clarify_handoff_source: workdocs/归档/设计/2026-03-06-composite-query-multimodal-response-design.md#clarify_handoff_contract
...
traceability_matrix:
  - design_item: D-01
    ...
    evidence_entry: workdocs/归档/实施计划/composite-query-multimodal-response-contract_implementation_plan.md
  - design_item: D-02
    fr_id: FR-02
