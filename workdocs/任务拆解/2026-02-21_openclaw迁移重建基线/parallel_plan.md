...
```yaml
automation_contract:
  source_of_truth: workdocs/任务拆解/2026-02-21_openclaw迁移重建基线/contracts/_active_task.json
  required_fields:
    - project_id
    - task_split_dir
    - task_key
...
- 协议机读文件: `workdocs/任务拆解/2026-02-21_openclaw迁移重建基线/contracts/sse_events_v1.json`
...
| G03 | G3 | G-3 | 契约一致性 Gate（planning_contract/vk_cards/cron 对齐） | workdocs/任务拆解/2026-02-21_openclaw迁移重建基线/contracts/vk_cards.json | python3 /Users/jijingkun/.codex/worktrees/978e/fastapi/scripts/docs_guard.py --strict | WAVE_ROLLBACK_DRILL_MATRIX |
