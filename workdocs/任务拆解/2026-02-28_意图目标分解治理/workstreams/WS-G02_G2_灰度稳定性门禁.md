...
card_export:
  ...
  soft_depends_on: []
  depends_on: ["G01"]
  file_whitelist: ["tests/integration/test_intent_shadow_metrics.py", "workdocs/归档/实施计划/意图目标分解治理_implementation_plan.md"]
  readonly_scope: []
  owner_fields: []
  mechanism_summary: ["检查 shadow 指标窗口是否在阈值内", "检查回滚演练记录是否完整可追溯", "确认灰度放量前置门禁满足"]
  code_anchor_refs: ["tests/integration/test_intent_shadow_metrics.py", "workdocs/归档/实施计划/意图目标分解治理_implementation_plan.md"]
  example_refs: ["workdocs/归档/实施计划/意图目标分解治理_implementation_plan.md#7", "workdocs/归档/实施计划/意图目标分解治理_implementation_plan.md#11"]
