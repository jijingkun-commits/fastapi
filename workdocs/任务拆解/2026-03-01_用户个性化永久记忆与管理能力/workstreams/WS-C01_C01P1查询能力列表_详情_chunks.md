# WS-C01 C01 P1 查询能力（列表/详情/chunks）
...
- 提供 memories 语义列表接口，支持分页与多条件筛选
- 详情与 chunks 分离加载，避免列表返回全文
- 所有查询路径统一管理员鉴权并记录查询审计
...
- 代码锚点（函数/类级）:
  ...
  - `app/api/v1/endpoints/memory_admin_api.py::get_memory_detail`
...
card_export:
  ...
  card_key: PP-20260301-USER-MEMORY-ADMIN::WS-C01
  title: C01 P1 查询能力（列表/详情/chunks）
  type: parallel
