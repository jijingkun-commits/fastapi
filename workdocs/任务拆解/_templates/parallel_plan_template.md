...
> 本文件由 `vk_cards.json` 自动生成，仅供人工阅读与审阅；禁止把它作为独立机器真理源手工维护。

> 计划 ID: PP-YYYYMMDD-XXX  
> 主题: <需求主题>  
> 输入来源: `workdocs/归档/需求/<topic>_requirements.md` / `workdocs/归档/实施计划/<topic>_implementation_plan.md`
...
```yaml
automation_contract:
  source_of_truth: workdocs/任务拆解/<task_split_dir>/contracts/_active_task.json
  required_fields:
    - project_id
    - task_split_dir
    - task_key
