...
- 对应 `task_key`:
- 来源主计划：`workdocs/归档/实施计划/<topic>_implementation_plan.md`
...
card_export:
  ...
  example_refs:
    - workdocs/归档/实施计划/<topic>_implementation_plan.md#L1
  acceptance_checks:
    - venv/bin/python -m pytest -q tests/unit/test_x.py
    - python3 scripts/docs_guard.py --strict
  rollback_anchors:
    - ENABLE_X=true|false
  evidence_entry: workdocs/归档/实施计划/<topic>_implementation_plan.md#...
  check_cmd:
    - venv/bin/python -m pytest -q tests/unit/test_x.py
  handoff_artifacts:
    - workdocs/任务拆解/<YYYY-MM-DD_主题>/contracts/sse_events_v1.json
  done_gate:
    - DoD-1
```
