...
- 代码锚点（函数/类级）:
  - `docs/内部参考/任务拆解/2026-03-01_聊天断页续跑与强停止/_active_task.json::scope`
...
### 可修改（白名单）
- `docs/内部参考/任务拆解/2026-03-01_聊天断页续跑与强停止/parallel_plan.md`
- `docs/内部参考/任务拆解/2026-03-01_聊天断页续跑与强停止/vk_cards.json`
...
card_export:
  ...
  done_gate:
    - 文档索引与关键验收命令全绿
  source_ws_file: docs/内部参考/任务拆解/2026-03-01_聊天断页续跑与强停止/workstreams/WS-G01_G01Gate全链路验收门禁.md
```
