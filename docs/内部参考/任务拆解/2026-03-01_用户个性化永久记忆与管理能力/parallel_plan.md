...
| `docs/内部参考/迭代需求/用户个性化永久记忆与管理能力_implementation_plan.md` | WS-C06/WS-G01 | 否 | Gate 卡独占回填证据 |

## 6. 依赖图与里程碑

- 依赖图: `C01 -> C02 -> C03 -> C06 -> G01`，侧支 `C01 -> C04 -> C06`，`C01,C02 -> C05 -> C06`。
- 里程碑:
