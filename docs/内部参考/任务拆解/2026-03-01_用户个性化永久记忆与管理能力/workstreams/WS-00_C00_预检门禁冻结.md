...
- 代码锚点（函数/类级）:
  - `docs/内部参考/任务拆解/2026-03-01_用户个性化永久记忆与管理能力/vk_cards.json::card_order`
  - `docs/内部参考/任务拆解/2026-03-01_用户个性化永久记忆与管理能力/_active_task.json::task_key`
- 最小样例（可伪代码）:
...
- `docs/内部参考/任务拆解/2026-03-01_用户个性化永久记忆与管理能力/preflight_status.json`
