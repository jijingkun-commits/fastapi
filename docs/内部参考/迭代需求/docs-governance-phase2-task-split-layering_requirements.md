...
### 1.2 范围
- `docs/plans/2026-03-11-docs-governance-phase2-task-split-layering-design.md`
- `workdocs/任务拆解/**`
...
- 不在本轮把 `docs/plans/**` 全量迁到 `workdocs/方案/**`。
...
requirements_contract:
  ...
  status: "approved"
  design_source: docs/plans/2026-03-11-docs-governance-phase2-task-split-layering-design.md
  clarify_handoff_source: docs/plans/2026-03-11-docs-governance-phase2-task-split-layering-design.md#clarify_handoff_contract
