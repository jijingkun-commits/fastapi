...
> 上游设计：`docs/plans/2026-03-11-docs-governance-phase2-task-split-layering-design.md`
> 对应需求：`docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_requirements.md`
> 文档目标：定义 HOW（implementation_tasks、PR 映射、执行合同、实施就绪度），供 `$jjk-imp` 直接承接

## 0. 输入来源清单
- design：`docs/plans/2026-03-11-docs-governance-phase2-task-split-layering-design.md`
- requirements：`docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_requirements.md`
- Phase 1 requirements：`docs/内部参考/迭代需求/文档分层治理与信息架构收敛_requirements.md`
- Phase 1 implementation：`docs/内部参考/迭代需求/文档分层治理与信息架构收敛_implementation_plan.md`
...
- 必须同步更新目录说明与流程图：`docs/README.md`、`docs/SUMMARY.md`、`workdocs/README.md`、`workdocs/任务拆解/README.md`、`.cursor/rules/doc_sync.mdc`、`docs/开发文档/工作流/文档治理基线清单.md`。
- 旧 `docs/内部参考/任务拆解/**` 下的机器 JSON / 过程 JSON 在迁移 PR 内直接删除，不保留 symlink / thin index。
...
implementation_tasks:
  ...
  - task_id: T05
    ...
    file_paths:
      ...
      - docs/开发文档/工作流/文档治理基线清单.md
    symbols:
      - docs_task_split_block
      - phase2_boundary_text
      - phase2_flow_diagram
    acceptance_cmds:
      - rg -n "目录边界图|执行链流转图|workdocs/任务拆解/.+/contracts|reports/preflight_status.json|docs 不再承载 task_split 机器 JSON" docs/README.md docs/SUMMARY.md workdocs/README.md workdocs/任务拆解/README.md docs/开发文档/工作流/文档治理基线清单.md .cursor/rules/doc_sync.mdc
  ...
  - task_id: T06
    ...
    file_paths:
      - memory-bank.md
      - docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_requirements.md
      - docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_implementation_plan.md
      - docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_clarify_plan_alignment.json
      - docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_planning_temporal_gate.json
    symbols:
      - phase2_decision_record
      - clarify_plan_alignment
      - planning_temporal_gate
    acceptance_cmds:
      - PYTHON_BIN="$(bash scripts/repo_python.sh)" && "$PYTHON_BIN" scripts/check_workflow_contract.py --mode clarify_plan --requirements-path docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_requirements.md --implementation-path docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_implementation_plan.md --output docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_clarify_plan_alignment.json
      - PYTHON_BIN="$(bash scripts/repo_python.sh)" && "$PYTHON_BIN" scripts/check_workflow_contract.py --mode planning_temporal_gate --implementation-path docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_implementation_plan.md --output docs/内部参考/迭代需求/docs-governance-phase2-task-split-layering_planning_temporal_gate.json
```
...
tc_task_mapping:
  ...
  - tc_id: TC-DGP2-05
    task_id: T05
    pr_id: PR-03
    acceptance_cmd_ref: rg -n "目录边界图|执行链流转图|workdocs/任务拆解/.+/contracts|reports/preflight_status.json|docs 不再承载 task_split 机器 JSON" docs/README.md docs/SUMMARY.md workdocs/README.md workdocs/任务拆解/README.md docs/开发文档/工作流/文档治理基线清单.md .cursor/rules/doc_sync.mdc
  - tc_id: TC-DGP2-06
    task_id: T06
    pr_id: PR-03
