...
#### [app/db/init_db.py](file:///Users/jijingkun/bojxAI/fastapi/app/db/init_db.py)

- [x] 补全 admin 用户的 `data_role="head_president"`、`org_code="0000"`、`org_name="总行"`

#### [scripts/init_tables_ci.py](file:///Users/jijingkun/bojxAI/fastapi/scripts/init_tables_ci.py)

- [x] 与 `init_db.py` 保持一致

#### [install/scripts/init_postgres.sql/027_seed_head_president_permissions.sql](file:///Users/jijingkun/bojxAI/fastapi/install/scripts/init_postgres.sql/027_seed_head_president_permissions.sql)
