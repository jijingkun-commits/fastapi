...
requirements_contract:
  ...
  clarify_handoff_source: docs/plans/2026-03-09-supervisor-conversation-state-ownership-design.md#clarify_handoff_contract
...
traceability_matrix:
  - design_item: D-01
    ...
    evidence_entry: docs/内部参考/迭代需求/监督者主会话状态归属与附件规划_implementation_plan.md
  - design_item: D-02
    fr_id: FR-02
