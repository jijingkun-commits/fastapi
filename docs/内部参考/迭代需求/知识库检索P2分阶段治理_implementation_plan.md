...
1. `docs/plans/2026-03-01-kb-retrieval-p2-phased-design.md`
2. `docs/内部参考/迭代需求/知识库检索P2分阶段治理_requirements.md`
...
- 设计文档：`docs/plans/2026-03-01-kb-retrieval-p2-phased-design.md`
...
1. `docs/plans/2026-03-01-kb-retrieval-p2-phased-design.md`（设计）  
...
| P5-02 | S5 | 灰度与回滚运行手册 | 放量 -> 监控 -> 触发回滚 | `docs/内部参考/迭代需求/知识库检索P2分阶段治理_implementation_plan.md` | `rollout_stage` | 一键切回 S2/S4 配置 | `python3 scripts/docs_guard.py --strict` | 设计文档 §17 |
...
planning_contract:
  ...
  cards:
    - card_id: C01
      ...
      acceptance_checks:
        - venv/bin/python scripts/data/kb_offline_evaluation.py --dry-run
      evidence_entry: docs/内部参考/迭代需求/知识库检索P2分阶段治理_implementation_plan.md
