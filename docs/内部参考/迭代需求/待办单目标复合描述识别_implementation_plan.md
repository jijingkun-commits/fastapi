...
1. `docs/内部参考/迭代需求/fix_plan_todo_compound_clarify_loop_20260301.md`
2. `docs/内部参考/迭代需求/待办单目标复合描述识别_requirements.md`
...
planning_contract:
  ...
  cards:
    - card_id: C01
      ...
      acceptance_checks:
        - venv/bin/python -m pytest -q tests/unit/test_todo_nodes.py -k "compound_single_goal or single_todo_preference"
      evidence_entry: docs/内部参考/迭代需求/待办单目标复合描述识别_implementation_plan.md
