...
> 上游设计：`docs/plans/2026-03-10-admin-overview-cockpit-slimming-design.md`  
> 关联需求：`docs/内部参考/迭代需求/admin-overview-cockpit-slimming_requirements.md`
...
implementation_tasks:
  ...
  - task_id: T-04
    ...
    file_paths:
      ...
      - docs/内部参考/迭代需求/admin-overview-cockpit-slimming_requirements.md
      - docs/内部参考/迭代需求/admin-overview-cockpit-slimming_implementation_plan.md
    symbols:
    ...
    acceptance_cmds:
      - python3 scripts/check_workflow_contract.py --mode clarify_plan --requirements-path docs/内部参考/迭代需求/admin-overview-cockpit-slimming_requirements.md --implementation-path docs/内部参考/迭代需求/admin-overview-cockpit-slimming_implementation_plan.md --output docs/内部参考/迭代需求/admin-overview-cockpit-slimming_clarify_plan_alignment.json
      - python3 scripts/check_workflow_contract.py --mode planning_temporal_gate --implementation-path docs/内部参考/迭代需求/admin-overview-cockpit-slimming_implementation_plan.md --output docs/内部参考/迭代需求/admin-overview-cockpit-slimming_planning_temporal_gate.json
...
acceptance_cmd_registry:
  ...
  - task_id: T-04
    acceptance_cmds:
      ...
      - kind: integration
        cmd: python3 scripts/check_workflow_contract.py --mode planning_temporal_gate --implementation-path docs/内部参考/迭代需求/admin-overview-cockpit-slimming_implementation_plan.md --output docs/内部参考/迭代需求/admin-overview-cockpit-slimming_planning_temporal_gate.json
      - kind: scripted_flow
...
execution_contract:
  ...
  requirements_source: docs/内部参考/迭代需求/admin-overview-cockpit-slimming_requirements.md
```
