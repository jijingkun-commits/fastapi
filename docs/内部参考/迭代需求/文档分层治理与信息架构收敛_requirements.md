...
- 稳定文档目录：`docs/产品文档/**`、`docs/开发文档/**`、`docs/API文档/**`、`docs/api/**`
- 内部知识目录：`docs/内部参考/**`
- 过程文档目录：`docs/plans/**`、`docs/内部参考/迭代需求/**`、`docs/内部参考/任务拆解/**`，以及拟新增 `workdocs/**`
- 运行态目录：拟新增 `.artifacts/**`
...
- `docs/plans/**`、`docs/内部参考/迭代需求/**`、`docs/内部参考/任务拆解/**` 当前仍允许作为迁移期旧过程路径存在，但不再作为主导航入口。
...
requirements_contract:
  ...
  clarify_handoff_source: docs/plans/2026-03-10-docs-governance-layering-design.md#clarify_handoff_contract
...
fr_contract_matrix:
  - fr_id: FR-01
    ...
    input_contract:
      ...
      source_of_truth: docs/plans/2026-03-10-docs-governance-layering-design.md
    output_contract:
...
traceability_matrix:
  ...
  - task_id: T02
    fr_id: FR-01
    nfr_ids: [NFR-03]
    acceptance_cmd_ref: test -d workdocs/需求 && test -d workdocs/方案 && test -d workdocs/任务拆解
  - task_id: T03
    fr_id: FR-02
    nfr_ids: [NFR-02]
