...
|------|------|------|------|------|----------|----------|
| SP-001 | 消息去重机制 | 数据一致性 | 中 | 已修复 | 2026-01-31 | 2026-02-03 |
| SP-002 | DeepSeek reasoning_content 补丁 | 框架兼容 | 中 | 跟踪中 | 2026-01-31 | 2026-01-31 |
| SP-003 | 异常吞没模式 | 错误处理 | 高 | 待处理 | 2026-01-31 | 2026-01-31 |
| SP-004 | 前端类型断言绕过 | 类型安全 | 中 | 待处理 | 2026-01-31 | 2026-01-31 |
| SP-005 | MinIO URL 编码修复 | 数据处理 | 低 | 可接受 | 2026-01-31 | 2026-01-31 |
| SP-006 | is_intermediate 中间消息标记 | 数据一致性 | 中 | 跟踪中 | 2026-01-31 | 2026-01-31 |
| SP-007 | SessionStorage 组件通信 | 架构设计 | 中 | 待处理 | 2026-01-31 | 2026-01-31 |
| SP-008 | 默认值兜底逻辑 | 错误处理 | 中 | 待处理 | 2026-01-31 | 2026-01-31 |
| SP-009 | 图片链接自动修复 | 数据处理 | 低 | 可接受 | 2026-01-31 | 2026-01-31 |
| SP-010 | 调试日志硬编码路径 | 代码质量 | 高 | 待处理 | 2026-01-31 | 2026-01-31 |
...
2. **统一消息 ID**：确保所有消息都有唯一 ID，可进一步简化去重逻辑
