...
|------|------|------|------|------|----------|----------|
| SP-001 | 消息去重机制 | 数据一致性 | 中 | 已修复 | 2026-01-31 | 2026-03-04 |
| SP-002 | DeepSeek reasoning_content 补丁 | 框架兼容 | 中 | 跟踪中 | 2026-01-31 | 2026-03-04 |
| SP-003 | 异常吞没模式 | 错误处理 | 中 | 可接受 | 2026-01-31 | 2026-03-04 |
...
| SP-009 | 图片链接自动修复 | 数据处理 | 低 | 可接受 | 2026-01-31 | 2026-03-04 |
| SP-010 | 调试日志硬编码路径 | 代码质量 | - | 已修复 | 2026-01-31 | 2026-02-04 |
| SP-011 | 知识库图片占位符机制 | 架构设计 | 低 | 可接受 | 2026-01-31 | 2026-03-04 |
| SP-012 | 待办卡片乐观更新 | 架构设计 | 低 | 可接受 | 2026-02-02 | 2026-02-02 |
| SP-013 | streaming_wrapper 上帝函数 | 架构设计 | 中 | 跟踪中 | 2026-02-04 | 2026-03-04 |
...
| SP-016 | SSE 状态文案归一化防闪烁 | 交互兼容 | 低 | 已修复 | 2026-02-14 | 2026-03-04 |
...
| SP-020 | Planner 模型主判定失败兜底 | 兼容补丁 | 中 | 跟踪中 | 2026-02-28 | 2026-03-04 |
