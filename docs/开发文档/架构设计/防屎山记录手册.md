...
| SP-006 | is_intermediate 中间消息标记 | 数据一致性 | 低 | 可接受 | 2026-01-31 | 2026-03-10 |
| SP-007 | SessionStorage 组件通信 | 架构设计 | 中 | 待处理 | 2026-01-31 | 2026-03-09 |
| SP-008 | 默认值兜底逻辑 | 错误处理 | 中 | 待处理 | 2026-01-31 | 2026-03-10 |
...
| SP-019 | DataGraph 会话帧回收兜底 | 兼容补丁 | 中 | 跟踪中 | 2026-02-18 | 2026-03-10 |
...
| SP-002 | `app/services/chat_service.py` | run control 收口时触碰聊天主链路，但没有继续扩大 `reasoning_content` 兼容补丁范围 | 保持“跟踪中” |
