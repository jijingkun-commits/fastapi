...
|------|------|------|------|------|----------|----------|
| SP-001 | 消息去重机制 | 数据一致性 | 中 | 已修复 | 2026-01-31 | 2026-02-04 |
| SP-002 | DeepSeek reasoning_content 补丁 | 框架兼容 | 中 | 跟踪中 | 2026-01-31 | 2026-02-04 |
| SP-003 | 异常吞没模式 | 错误处理 | 中 | 可接受 | 2026-01-31 | 2026-02-04 |
| SP-004 | 前端类型断言绕过 | 类型安全 | 中 | 待处理 | 2026-01-31 | 2026-02-04 |
| SP-005 | MinIO URL 编码修复 | 数据处理 | 低 | 可接受 | 2026-01-31 | 2026-01-31 |
| SP-006 | is_intermediate 中间消息标记 | 数据一致性 | 低 | 可接受 | 2026-01-31 | 2026-02-04 |
| SP-007 | SessionStorage 组件通信 | 架构设计 | 中 | 待处理 | 2026-01-31 | 2026-02-04 |
| SP-008 | 默认值兜底逻辑 | 错误处理 | 中 | 待处理 | 2026-01-31 | 2026-01-31 |
| SP-009 | 图片链接自动修复 | 数据处理 | 低 | 可接受 | 2026-01-31 | 2026-02-15 |
| SP-010 | 调试日志硬编码路径 | 代码质量 | - | 已修复 | 2026-01-31 | 2026-02-04 |
| SP-011 | 知识库图片占位符机制 | 架构设计 | 低 | 可接受 | 2026-01-31 | 2026-02-15 |
| SP-012 | 待办卡片乐观更新 | 架构设计 | 低 | 可接受 | 2026-02-02 | 2026-02-02 |
| SP-013 | streaming_wrapper 上帝函数 | 架构设计 | 中 | 跟踪中 | 2026-02-04 | 2026-02-18 |
| SP-014 | internal 协议块清洗与 metadata 序列化兜底 | 协议兼容 | 中 | 跟踪中 | 2026-02-08 | 2026-02-08 |
| SP-015 | Vision 路由兼容多模态 Chat 模型 | 架构兼容 | 中 | 已修复 | 2026-02-14 | 2026-02-14 |
| SP-016 | SSE 状态文案归一化防闪烁 | 交互兼容 | 低 | 已修复 | 2026-02-14 | 2026-02-15 |
...
| SP-020 | Planner 模型主判定失败兜底 | 兼容补丁 | 中 | 跟踪中 | 2026-02-28 | 2026-02-28 |
