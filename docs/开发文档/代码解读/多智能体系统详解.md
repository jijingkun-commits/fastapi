...
sequenceDiagram
    ...
    rect rgb(255, 248, 240)
        ...
        alt 简单任务:直接回复或调用工具
            ...
            Graph->>Graph: handoff -> data/todo/knowledge expert
        end
    end
