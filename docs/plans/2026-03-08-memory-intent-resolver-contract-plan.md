...
**Files:**
- Create: `docs/plans/2026-03-08-memory-intent-resolver-contract-design.md`
- Create: `docs/plans/2026-03-08-memory-intent-resolver-contract-plan.md`
...
**Step 4: 自检文档同步**
Run: `rg -n 'resolver|contract|异步|chat_service|normalized_value' docs/plans/2026-03-08-memory-intent-resolver-contract-*.md memory-bank.md`
