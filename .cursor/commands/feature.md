...
1. **Vibe Coding**:
    ...
    - 遵循 `rules.md` (中文注释, 架构一致, 可读可维护, 无冗余)

## 阶段 3: 自动文档同步 (Auto Doc Sync)

> **编码完成后，自动执行以下文档更新**（无需手动调用 `/api-docs`）：

### 3.1 API 文档

如果新增/修改了 API，按以下格式更新 `docs/API文档/接口文档.md`：
...
如果新增/修改了表结构，更新 `docs/开发文档/架构设计/数据库设计.md`：
...
如果新增配置项，更新 `docs/开发文档/快速入门/配置说明.md`。
